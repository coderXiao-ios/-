...
{
    return (array != nil && ![array isKindOfClass:[NSNull class]] && array.count != 0) ? NO : YES;
}
///**
// *  判断数组是否包含相同元素
// */
...
//        GiftModel *model = array[i];
//        if ([model.ID isEqualToString:ob.ID]) {
//            return YES;
//        }
//    }
//    return NO;
