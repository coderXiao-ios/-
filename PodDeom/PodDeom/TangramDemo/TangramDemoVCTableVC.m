...
#import "TangramDemoVCTableVC.h"
#import "CustomTangranmVC.h"
#import "MockViewController.h"

@interface TangramDemoVCTableVC ()
@property (nonatomic, strong) NSArray *testArray;
@end

@implementation TangramDemoVCTableVC
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        [self.navigationController pushViewController:[[CustomTangranmVC alloc]init] animated:YES];
    }
    if (indexPath.row == 1) {
